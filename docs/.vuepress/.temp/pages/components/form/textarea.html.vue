<template><div><h1 id="textarea" tabindex="-1"><a class="header-anchor" href="#textarea"><span>Textarea</span></a></h1>
...
<td>The unique identifier for the textarea field.</td>
</tr>
<tr>
<td><code v-pre>icon</code></td>
<td><code v-pre>string</code></td>
<td>-</td>
<td>Icon used in the label (<code v-pre>FgLabel</code>).</td>
</tr>
<tr>
...
<td><code v-pre>string</code></td>
<td>-</td>
<td>Informational or hint text displayed below the textarea (<code v-pre>FgInfo</code>).</td>
</tr>
<tr>
<td><code v-pre>error</code></td>
<td><code v-pre>string</code></td>
<td>-</td>
<td>Error message displayed below the textarea (<code v-pre>FgError</code>).</td>
</tr>
<tr>
<td><code v-pre>modelValue</code></td>
<td><code v-pre>string</code></td>
<td><code v-pre>''</code></td>
<td>Bound value of the textarea. Supports v-model.</td>
</tr>
<tr>
...
<tr>
<td><code v-pre>rows</code></td>
<td><code v-pre>string | number</code></td>
<td><code v-pre>4</code></td>
<td>Number of visible text lines in the textarea.</td>
</tr>
<tr>
...
<Tabs id="190" :data='[{"id":"Preview"},{"id":"vue"}]' :active="0">
<template #title0="{ value, isActive }">Preview</template>
<template #title1="{ value, isActive }">vue</template>
<template #tab0="{ value, isActive }">
<fg-textarea label="About you" placeholder="Insert your bio"/></template>
<template #tab1="{ value, isActive }">
<div class="language-vue line-numbers-mode" data-highlighter="shiki" data-ext="vue" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre class="shiki shiki-themes one-light one-dark-pro vp-code" v-pre=""><code><span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">&#x3C;</span><span style="--shiki-light:#E45649;--shiki-dark:#E06C75">fg-textarea</span><span style="--shiki-light:#986801;--shiki-dark:#D19A66"> label</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">=</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379">"About you"</span><span style="--shiki-light:#986801;--shiki-dark:#D19A66"> placeholder</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">=</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379">"Insert your bio"</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF"> /></span></span></code></pre>
